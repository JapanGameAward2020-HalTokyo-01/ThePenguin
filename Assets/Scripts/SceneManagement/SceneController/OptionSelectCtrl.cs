/**
 * @file	OptionSelectCtrl.cs
 * @brief	オプション画面の選択肢に関わるUIの操作クラス
 * @auther	谷沢　瑞己
 */
...
/**
 * @class	OptionSelectCtrlクラス
 * @brief	オプション画面の選択肢に関わるUIの操作クラス
 */
public class OptionSelectCtrl : MonoBehaviour
{
	//! 選択肢が表示されているか
	...
	{
		// 選択肢パネルのアクティブ状態を変更する
		foreach (RectTransform panel in m_list_panel) panel.gameObject.SetActive(isActive);
