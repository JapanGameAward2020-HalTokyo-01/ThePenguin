            ...
            else
            {
                ...
                else if(m_Timer> m_WaitTimeToMove_1 + m_Middle_MoveTime + m_Middle_WaitTime)
                {
                    ...
                    if (m_Timer > m_MaskThreshold && !m_BeforeMaskOn)
                    {
                        if (SEloopIndex == -1)
                        {
                            SEloopIndex = SoundEffect.Instance.PlayLoopSE(SoundEffect.Instance.SEList.Hero_Changing, 0.504f); 
                        }
                    ...
                    if (m_Timer > m_MaskThreshold + 2.0f && !m_AfterMaskOn)
                    {
                        ...
                        SoundEffect.Instance.PlayOneShot(SoundEffect.Instance.SEList.Hero_Change_Finsih, 0.504f, 128);
